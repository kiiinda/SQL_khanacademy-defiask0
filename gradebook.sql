...
INSERT INTO student_grades (name, number_grade, fraction_completed)
    ...
    /*output the letter_grade by using CASE with the number_grade column, outputting 'A' for grades > 90, 'B' for grades > 80, 'C' for grades > 70, and 'F' otherwise. 
    ...
    ELSE "F" 
    END AS number_students
    FROM student_grades
    GROUP BY number_students;
